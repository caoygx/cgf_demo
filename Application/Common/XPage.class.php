...
class XPage{
	...
	public $style=0;
	// CSS类名
	public $classNames=array("digg","baidu","default","yahoo","meneame","flickr","sabrosus","pagination","scott","quotes","black","black2","grayr","yellow","jogger","starcraft2","tres","megas512","technorati","youtube","msdn","badoo","green","viciao","yahoo2");
	// 页数跳转时要带的参数
	public $parameter  ;
	// 分页总页面数
