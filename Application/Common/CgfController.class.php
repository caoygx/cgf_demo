...
use Common\Cgf\Form\BootstrapForm;
use Common\Cgf\FrameworkInterface;
use Common\Cgf\Validate\ThinkphpValidate;
use Common\MysqlTableInfo;
...
class CgfController extends CommonController implements FrameworkInterface
{
    ...
    public function __construct($pre = '', $modelName = '')
    {
        ...
        if (!empty($this->m)) {
            ...
            $this->cgf        = new Cgf($tableName, C('DB_PREFIX'), $this, $formHandler, $tableInfoHandler);
...
//var_dump($r);exit;
    ...
    function _generateListsTemplate()
    {
        ...
        $f_action   = $this->cgf->definition->getTableDefinition()['action'];
        $pageButton = $this->cgf->definition->getTableDefinition()['pageButton'];
