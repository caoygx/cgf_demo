...
return array(
    ...
    /* 错误设置 */
    'ERROR_MESSAGE'          => '出错了!请联系客服！', //错误显示信息,非调试模式有效
    'ERROR_PAGE'             => '', // 错误定向页面
    ...
    'TMPL_ACTION_SUCCESS_WAP'    => THINK_PATH . 'Tpl/wap_dispatch_jump.tpl', // 默认成功跳转对应的模板文件
	'TMPL_ACTION_ERROR_WAP'      => THINK_PATH . 'Tpl/wap_dispatch_jump.tpl', // 默认错误跳转对应的模板文件
